...
%     type_num=9;
    %样本空间0
    [acc0,predictLable0,scores0] = z_predict(sample_pair_trainX,trainX_deep_cluster0,trainY,sample_pair_testX,testX_deep_cluster0,testY,type_num);

    %样本空间1
    [acc1,predictLable1,scores1] = z_predict(sample_pair_trainX1,trainX_deep_cluster1,trainY1,sample_pair_testX1,testX_deep_cluster1,testY,type_num);

    %样本空间2  
    [acc2,predictLable2,scores2] = z_predict(sample_pair_trainX2,trainX_deep_cluster2,trainY2,sample_pair_testX2,testX_deep_cluster2,testY,type_num);
